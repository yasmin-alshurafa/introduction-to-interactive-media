...
//text font, color and size 
  ...
  //open the Arduino's port (3) at the same speed of Arduino
  println(Serial.list());
...
//send an 'G' to open green LED
    myPort.write('G');
    
    
  }else{
    
//send an 'O' to close green LED   
    myPort.write('O');
...
//the player lost
      lost = true;
//send an 'R' to open red LED and buzzer
      myPort.write('R'); 
    }
  }
}
